...
| -------- | --- | --- | ------- | --- |
| 학점가방 | 2024.07 </br>~ 2025.5 | 학생 편의 개선 목적의 동국대학교 학사/생활 통합 서비스 | Node.js, Flutter, MySQL, Redis | 팀 프로젝트 |
| 함께, 경주 | 2024.11 | 카드 형태의 숏폼을 이용한 경주시와 시민의 정책 소통 플랫폼 | React.js, MySQL | 팀 프로젝트</br>(해커톤) |
| POLY DASH | 2024.4 | DRM 시스템의 관리용 웹 대시보드 | Flask, Sqlite | 개인 프로젝트 |
